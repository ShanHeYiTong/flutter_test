...
class PengYouQuan extends StatefulWidget {
  //固定写法
//   ContactsDetail({Key key}) : super(key: key);
  // PengYouQuan({Key? key, @required this.mt}) : super(key: key);
  //信息
  // final mt;

  @override
  PengYouQuanState createState() {
    // TODO: implement createState
    return new PengYouQuanState();
  }
}

//有状态控件  就必须有状态管理类 来进行实现
class PengYouQuanState extends State<PengYouQuan>
